...
function ProjectsSection() {
  ...
  date: "Dec 2024",
},
    {
      ...
      description:
        "Interactive weather dashboard providing current conditions, forecasts, weather maps, and location-based alerts with beautiful data visualizations.",
      tech: [
        "React",
        "OpenWeather API",
        "Chart.js",
    ...
    },
    {
      ...
      description:
        "Modern social networking platform with real-time messaging, post sharing, user profiles, friend connections, and content discovery features.",
    ...
    },
    {
      ...
      description:
        "Responsive portfolio website showcasing projects, skills, and experience with interactive animations, contact forms, and blog functionality.",
      tech: ["React", "Tailwind CSS", "Framer Motion", "EmailJS", "Netlify"],
      features: [
        "Interactive Design",
        "Contact Forms",
        "Blog",
    ...
    },
    {
      ...
      description:
        "Comprehensive expense tracking application with budget planning, category-wise analysis, spending insights, and financial goal setting features.",
    ...
    },
    {
      ...
      description:
        "Recipe discovery platform with ingredient-based search, nutritional information, cooking timers, meal planning, and user recipe collections.",
      tech: [
        "React",
        "Spoonacular API",
        "Local Storage",
    ...
    },
    {
      ...
      description:
        "Real-time chat application with private messaging, group chats, file sharing, emoji support, and online status indicators.",
      tech: ["React", "Socket.io", "Node.js", "MongoDB", "Express", "Multer"],
      features: [
        "Real-time Messaging",
        "Group Chats",
        "File Sharing",
